...
def make_expected_seed_df():
    ...
    seeds = ["2187482", "2030942", "2084785", "2270486", "2173769",
             "2184592", "2184360", "2202440", "2173766", "2028986",
             "2122426", "2084781", "2120634", "2084780", "2089428",
             "2070895", "2018084"]

    aips = ["harg-0000-web-202006-0001", "harg-0000-web-202006-0002",
    ...
    titles = ["Student Government Association Facebook", "UGA NAACP Twitter",
    ...
    ait_colls = ["12181", "12181", "12181", "12912", "12912",
                 "12912", "12912", "12181", "12912", "12470",
                 "12265", "12907", "12912", "12907", "12263",
                 "12264", "12262"]
    ...
    sizes = ["3.62", "0.05", "0.11", "0.06", "0.02", "0.28", "70.78", "0.43", "0.08", "1.3",
             "0.18", "2.29", "0.59", "0.03", "16.67", "3.64", "0.67"]
    ...
    infos = ["No additional information",
    ...
    apis = ["Successfully downloaded ARCHIVEIT-12181-TEST-JOB1177700-SEED2187482-20200601191649570-00000-h3.warc.gz; Successfully downloaded ARCHIVEIT-12181-TEST-JOB1177700-SEED2187482-20200601195532797-00002-h3.warc.gz; Successfully downloaded ARCHIVEIT-12181-TEST-JOB1177700-SEED2187482-20200601194617707-00001-h3.warc.gz; Successfully downloaded ARCHIVEIT-12181-TEST-JOB1177700-SEED2187482-20200601200733748-00003-h3.warc.gz",
    ...
    fixitys = ["Successfully verified ARCHIVEIT-12181-TEST-JOB1177700-SEED2187482-20200601191649570-00000-h3.warc.gz fixity on; Successfully verified ARCHIVEIT-12181-TEST-JOB1177700-SEED2187482-20200601195532797-00002-h3.warc.gz fixity on; Successfully verified ARCHIVEIT-12181-TEST-JOB1177700-SEED2187482-20200601194617707-00001-h3.warc.gz fixity on; Successfully verified ARCHIVEIT-12181-TEST-JOB1177700-SEED2187482-20200601200733748-00003-h3.warc.gz fixity on",
    ...
    unzips = ["Successfully unzipped ARCHIVEIT-12181-TEST-JOB1177700-SEED2187482-20200601191649570-00000-h3.warc.gz; Successfully unzipped ARCHIVEIT-12181-TEST-JOB1177700-SEED2187482-20200601195532797-00002-h3.warc.gz; Successfully unzipped ARCHIVEIT-12181-TEST-JOB1177700-SEED2187482-20200601194617707-00001-h3.warc.gz; Successfully unzipped ARCHIVEIT-12181-TEST-JOB1177700-SEED2187482-20200601200733748-00003-h3.warc.gz",
    ...
    df = pd.DataFrame({"Seed_ID": seeds, "AIP_ID": aips, "Title": titles, "Department": depts,
                       ...
                       "WARC_Unzip_Errors": unzips, "Files Deleted": deleted, "Objects Folder": objects, "Metadata Folder": metadata,
...
def make_expected_completeness_check_df():
    ...
    aip = ["harg-0000-web-202006-0001", "harg-0000-web-202006-0002", "harg-0000-web-202006-0003",
    ...
    df = pd.DataFrame({"AIP": aip, "URL": url, "AIP Folder Made": folder, "coll.csv": coll,
            ...
            "crawldef.csv count": crawldef, "crawljob.csv count": crawljob, "preservation.xml": presxml,
            "WARC Count Correct": warcs, "Objects is all WARCs": objects, "fits.xml Count Correct": fits,
            "No Extra Metadata": metadata})
    return df

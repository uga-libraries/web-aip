...
def make_expected_seed_df():
    ...
    rows = [["2187482", "harg-0000-web-202006-0001", "Student Government Association Facebook", 
            ...
            ["2018084", "rbrl-447-web-202006-0001", "K7MOA Legacy Voteview Website",
...
def make_expected_completeness_check_df():
    ...
    rows = [["harg-0000-web-202006-0001", "https://www.facebook.com/ugasga/", True, True, True, True, True, 1, 1, True, True, True, True, True],
            ...
            ["harg-0000-web-202006-0012", "https://twitter.com/UGAAthletics/", False, True, False, True, True, 1, 1, True, True, True, True, True],
            ["rbrl-459-web-202006-0001", "https://cleanenergy.org/", True, np.NaN, np.NaN, np.NaN, np.NaN, np.NaN, np.NaN, np.NaN, np.NaN, np.NaN, np.NaN, np.NaN],

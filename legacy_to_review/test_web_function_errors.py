"""Purpose: This script generates every known error to use for testing the error handling of warc_download.py.
...
# ----------------------------------------------------------------------------------------------------------------
# THIS PART OF THE SCRIPT IS THE SAME AS warc_download.py TO SET UP EVERYTHING CORRECTLY BEFORE THE DESIRED TESTS.

...
class MyTestCase(unittest.TestCase):
    ...
    def test_api_error_all(self):
        """
        Tests that the function creates the correct content in metadata.csv
        when all of the seeds have an API error.
        """
        metadata_csv(["error-one", "error-two"], "2019-01-02")

        actual_df = pd.read_csv(os.path.join(c.script_output, "preservation_download", "metadata.csv"))
        ...
        self.assertEqual(actual, expected, "Problem with test for API error, all errors")
    ...
    def test_api_error_one(self):
        ...
        """
        metadata_csv(["error-one", "2529685"], "2019-01-02")
        ...
        expected = [["Department", "Collection", "Folder", "AIP_ID", "Title", "Version"],
                    ...
                    ["API error 500", "TBD", "error-one", "TBD-web-201901-0001", "TBD", 1]]
        self.assertEqual(actual, expected, "Problem with test for API error, one error and one correct")

    def test_diff_collector(self):
        """
        Tests that the function creates the correct content in metadata.csv
        when the seed does not have one of the three expected collector values.
        """
        metadata_csv(["2141624"], "2019-01-02")
        ...
        self.assertEqual(actual, expected, "Problem with test for a different collector than the ones expected")
    ...
    def test_multiple_collection(self):
        ...
        """
        metadata_csv(["2184360", "2184592", "2912234", "2912237", "2912238"], "2019-01-02")
        ...
        self.assertEqual(actual, expected, "Problem with test for multiple seeds in the same collection")
    ...
    def test_no_collector_no_title(self):
        ...
        """
        metadata_csv(["2503951"], "2019-01-02")
        ...
        expected = [["Department", "Collection", "Folder", "AIP_ID", "Title", "Version"],
                    ["TBD: no collector in Archive-It", "TBD: unexpected department value", 2503951,
                     "TBD: unexpected department value-web-201901-0001",
                     "TBD: could not get title from Archive-It", 1]]
        self.assertEqual(actual, expected, "Problem with test for no collector or title")
    ...
    def test_no_relation(self):
        ...
        """
        metadata_csv(["2030942", "2527198", "2912227"], "2019-01-02")
        ...
        expected = [["Department", "Collection", "Folder", "AIP_ID", "Title", "Version"],
                    ...
                    ["russell", "rbrl-000", 2912227, "rbrl-000-web-201901-0001",
                     "Rep. Carolyn Bourdeaux | Facebook", 1]]
        self.assertEqual(actual, expected, "Problem with test for no relation")
    ...
    def test_one_seed(self):
        ...
        """
        metadata_csv(["2024247"], "2019-01-02")

        actual_df = pd.read_csv(os.path.join(c.script_output, "preservation_download", "metadata.csv"))
        actual = [actual_df.columns.tolist()] + actual_df.values.tolist()
        expected = [["Department", "Collection", "Folder", "AIP_ID", "Title", "Version"],
                    ["hargrett", "harg-0000", 2024247, "harg-0000-web-201901-0001", "Infusion Magazine website", 1]]
        self.assertEqual(actual, expected, "Problem with test for one seed")
    ...
    def test_seed_report_all(self):
        ...
        """
        metadata_csv(["2018084", "2028466"], "2019-01-02")
